...
First, based on the linearity of expectation, we have

$$
E[\frac{1}{k}\sum_{i=1}^{k}(x_i)] = \frac{E[x_1]+ ...+E[x_k]}{k} = \frac{k*E[x_1]}{k} = E[x_1]
$$

Then, we have
$$
\begin{align*}
E[R_{\text{train}}(\hat{\beta})] = E[( y_1-\hat\beta^T  x_1)^2]
\end{align*}
$$

$$
\begin{align*}
E[R_{\text{test}}(\hat{\beta})] = E[(\tilde y_1-\hat\beta^T \tilde x_1)^2]
\end{align*}
$$
Therefore, there is nothing to do with M and N.
